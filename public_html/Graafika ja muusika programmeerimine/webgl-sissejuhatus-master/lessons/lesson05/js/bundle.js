...
function setup() {
    ...
    APP.myVerticesData = [
        ...
        -1.0, -1.0,  1.0,  0.0, 1.0,            //ALUMINE VASAK NURK
         ...
         1.0,  1.0,  1.0,  1.0, 0.0,            //ĆLEMINE PAREM NURK
        -1.0,  1.0,  1.0,  5.0, 0.0,            //ĆLEMINE VASAK NURK
    ...
    //Tippude indeksid
    APP.myIndicesData = [
        0, 1, 2,      0, 2, 3,    // Esimene kĆ¼lg
        4, 5, 6,      4, 6, 7,    // Tagumine kĆ¼lg
        8, 9, 10,     8, 10, 11,  // Ćlemine kĆ¼lg
        12, 13, 14,   12, 14, 15, // Alumine kĆ¼lg
        16, 17, 18,   16, 18, 19, // Parem kĆ¼lg
        20, 21, 22,   20, 22, 23  // Vasak kĆ¼lg
    ];
...
function render() {
    ...
    //Ppuhastame ka vĆ¤rvi- ja sĆ¼gavuspuhvrid, ning mĆ¤Ć¤rame uue puhastuvĆ¤rvuse.
    ...
    //Aktiveerime ja mĆ¤Ć¤rame tekstuuri
